...
class LocalConnection(ConnectionBase):
    ...
    def __init__(self, platform: Optional['Platform'] = None,
        ...
        self.logger: Logger = logging.getLogger('local_connection')
    ...
    def push(self, sources: Tuple[str, ...], dest: str, timeout: Optional[int] = None,
        ...
        :param sources: Tuple of file or directory paths on the local system.
        :type sources: tuple of str
    ...
    def pull(self, sources: Tuple[str, ...], dest: str, timeout: Optional[int] = None,
             as_root: bool = False) -> None:  # pylint: disable=unused-argument
        """
        Transfer a list of files **from the local system** to the local system (similar to :meth:`push`).

        :param sources: Tuple of paths on the local system.
        :type sources: tuple of str
    ...
    def background(self, command: 'SubprocessCommand', stdout: int = subprocess.PIPE,
        ...
        popen: Popen[bytes] = subprocess.Popen(
            command,
            stdout=stdout,
            stderr=stderr,
