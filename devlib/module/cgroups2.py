...
@contextmanager
def _request_delegation(target: LinuxTarget) -> Generator[int, Any, None]:
    """
...
@contextmanager
def _mount_v2_controllers(target: LinuxTarget) -> Generator[str, Any, None]:
    """
...
@contextmanager
def _mount_v1_controllers(target: LinuxTarget, controllers: Set[str]) -> Generator[Dict[str, str], Any, None]:
    """
...
class _CGroupV2Root(_CGroupV2):
    ...
    @classmethod
    @contextmanager
    def _mount_filesystem(cls, target: LinuxTarget, requested_controllers: Set[str]) -> Generator[str, Any, None]:
        """
...
class _CGroupV1Root(_CGroupV1):
    ...
    @classmethod
    @contextmanager
    def _mount_filesystem(cls, target: LinuxTarget, requested_controllers: Set[str]) -> Generator[Dict[str, str], Any, None]:
        """
...
class RequestTree(_TreeBase):
    ...
    @contextmanager
    def setup_hierarchy(self, version: int, target: LinuxTarget) -> Generator['ResponseTree', Any, None]:
        """
