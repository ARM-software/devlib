...
from typing import (Dict, Optional, List, OrderedDict,
                    TYPE_CHECKING, Union, Callable, Generator,
                    Any, Tuple)
...
class MeasurementsCsv(object):
    ...
    def iter_measurements(self) -> Generator[List['Measurement'], Any, None]:
    ...
    def iter_values(self) -> Generator[Tuple[Any], Any, None]:
        for row in self._iter_rows():
    ...
    def _iter_rows(self) -> Generator[List[str], Any, None]:
        with csvreader(self.path) as reader:
